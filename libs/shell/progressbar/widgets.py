...
class Timer(Widget):
    ...
    def __init__(self, timer_format='Elapsed Time: %s'):
        self.format = timer_format
...
class Counter(Widget):
    ...
    def __init__(self, counter_format='%d'):
        self.format = counter_format
...
class Bar(WidgetHFill):
    ...
    def update(self, pbar, width):
        ...
        (left, marker, right) = (format_updatable(i, pbar) for i in (self.left, self.marker,
                self.right))
